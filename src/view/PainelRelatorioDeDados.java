...
public class PainelRelatorioDeDados extends JPanel{
	private Jogo jogo;
	private JButton sair;

	public PainelRelatorioDeDados(Janela janela, Jogo jogo) {
		this.jogo = jogo;
		...
		String pCavalo = "";
		String pRei = "";
		String Dados[][] = new String[jogo.NumJogadores()][9];
		Player aux = jogo.getJogadorDaVez();
